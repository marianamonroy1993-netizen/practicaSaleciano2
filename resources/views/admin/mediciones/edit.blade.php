                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control @error('destinatario_id') is-invalid @enderror"
                                        ...
                                        @foreach($destinatarios as $destinatario)
                                            <option value="{{ $destinatario->id }}" {{ old('destinatario_id', $medicion->destinatario_id) == $destinatario->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control @error('fecha_medicion') is-invalid @enderror"
                                        ...
                                        value="{{ old('fecha_medicion', $medicion->fecha_medicion->format('Y-m-d')) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('peso', $medicion->peso) }}" min="1" max="300" required
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('talla', $medicion->talla) }}" min="0.5" max="2.5" required
                                        style="border: 1px solid #808080; color: #000000;" oninput="calcularIMC()">
                                    @error('talla')
                                        <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="observaciones" name="observaciones" rows="3"
                                        style="border: 1px solid #808080; color: #000000;">{{ old('observaciones', $medicion->observaciones) }}</textarea>
                                </div>
                            </div>
