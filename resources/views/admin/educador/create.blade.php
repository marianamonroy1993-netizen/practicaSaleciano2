...
@section('title', 'Crear Seguimiento Educador')
            ...
            <div class="col-12">
                <div class="card" style="background-color: #ffffff; border: 1px solid #808080;">
                    <div class="card-header" style="background-color: #ffffff; border-bottom: 1px solid #808080;">
                        <h4 class="mb-0" style="color: #000000;">Registrar Nuevo Seguimiento Educador</h4>
                    </div>
                    <div class="card-body" style="background-color: #ffffff;">
                        <form action="{{ route('admin.educador.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-control @error('tipo') is-invalid @enderror" id="tipo" name="tipo"
                                        ...
                                        <option value="academico" {{ old('tipo') === 'academico' ? 'selected' : '' }}>
                                            Académico</option>
                                        <option value="convivencial" {{ old('tipo') === 'convivencial' ? 'selected' : '' }}>
                                            Convivencial</option>
                                        <option value="disciplinario" {{ old('tipo') === 'disciplinario' ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="nivel_riesgo" class="form-label" style="color: #000000;">Nivel de
                                        Riesgo</label>
                                    <select class="form-control @error('nivel_riesgo') is-invalid @enderror"
                                        id="nivel_riesgo" name="nivel_riesgo"
                                        style="border: 1px solid #808080; color: #000000;">
                                        <option value="bajo" {{ old('nivel_riesgo', 'bajo') === 'bajo' ? 'selected' : '' }}>
                                            Bajo</option>
                                        <option value="medio" {{ old('nivel_riesgo') === 'medio' ? 'selected' : '' }}>Medio
                                        </option>
                                        <option value="alto" {{ old('nivel_riesgo') === 'alto' ? 'selected' : '' }}>Alto
                                        </option>
                                    </select>
                                    @error('nivel_riesgo')
                                        <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                ...
                                <div class="col-md-8 mb-3">
                                    <div class="form-check mt-4">
                                        <input class="form-check-input" type="checkbox" id="riesgo_detectado"
                                            name="riesgo_detectado" value="1" {{ old('riesgo_detectado') ? 'checked' : '' }}
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('observacion') is-invalid @enderror"
                                        ...
                                        style="border: 1px solid #808080; color: #000000;">{{ old('observacion') }}</textarea>
                                    @error('observacion')
                                        <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="acuerdos" class="form-label" style="color: #000000;">Acuerdos y
                                        Compromisos</label>
                                    <textarea class="form-control @error('acuerdos') is-invalid @enderror" id="acuerdos"
                                        name="acuerdos" rows="3"
                                        style="border: 1px solid #808080; color: #000000;">{{ old('acuerdos') }}</textarea>
                                    @error('acuerdos')
                                        <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                    @enderror
                                </div>
