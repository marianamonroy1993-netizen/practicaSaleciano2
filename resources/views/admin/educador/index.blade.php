...
@section('title', 'Seguimiento Educador')
                ...
                <div class="card" style="background-color: #ffffff; border: 1px solid #808080;">
                    <div class="card-header" style="background-color: #ffffff; border-bottom: 1px solid #808080;">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0" style="color: #000000;">Seguimiento Educador</h4>
                            <div>
                                <a href="{{ route('admin.educador.create') }}" class="btn"
                                    ...
                                    @forelse($registros as $registro)
                                        <tr>
                                            ...
                                            <td style="color: #000000; border: 1px solid #808080;">
                                                {{ $registro->destinatario->nombre_completo ?? 'N/A' }}
                                            </td>
                                            ...
                                            <td style="color: #000000; border: 1px solid #808080;">
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('admin.educador.show', $registro) }}" class="btn btn-sm"
                                                        style="background-color: #dc3545; color: #ffffff; border: 1px solid #808080;">
                                                        <i class="bx bx-show" style="color: #ffffff;"></i>
                                                    </a>
                                                    <a href="{{ route('admin.educador.edit', $registro) }}" class="btn btn-sm"
                                                        style="background-color: #dc3545; color: #ffffff; border: 1px solid #808080;">
                                                        <i class="bx bx-edit" style="color: #ffffff;"></i>
                                                    </a>
                                                    <form action="{{ route('admin.educador.destroy', $registro) }}"
