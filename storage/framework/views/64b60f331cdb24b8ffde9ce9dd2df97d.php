...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Proyecto Salesiano Costa Norte</title>
    <meta name="description" content="" />
    <link rel="icon" type="image/jpeg" href="<?php echo e(asset('assets/img/icono.jpeg')); ?>" />
    <link rel="apple-touch-icon" href="<?php echo e(asset('assets/img/icono.jpeg')); ?>" />
                ...
                <div class="app-brand demo">
                    <a href="<?php echo e(route('home')); ?>" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <img src="<?php echo e(asset('assets/img/icono.jpeg')); ?>" alt="Proyecto Salesiano"
                ...
                <ul class="menu-inner py-1">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php if(auth()->user()->hasPermission('users.view')): ?>
                            <li class="menu-item <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(auth()->user()->hasPermission('roles.view')): ?>
                            <li class="menu-item <?php echo e(request()->routeIs('admin.roles.*') ? 'active' : ''); ?>">
                        ...
                        <!-- Destinatarios -->
                        <?php if(auth()->user()->hasPermission('destinatarios.view')): ?>
                            <li class="menu-item <?php echo e(request()->routeIs('admin.destinatarios.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.destinatarios.index')); ?>" class="menu-link">
                        ...
                        <!-- Mediciones -->
                        <?php if(auth()->user()->hasPermission('mediciones.view')): ?>
                            <li class="menu-item <?php echo e(request()->routeIs('admin.mediciones.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.mediciones.index')); ?>" class="menu-link">
                        ...
                        <!-- Psicología -->
                        <?php if(auth()->user()->hasPermission('psicologia.view')): ?>
                            <li class="menu-item <?php echo e(request()->routeIs('admin.psicologia.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.psicologia.index')); ?>" class="menu-link">
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <span class="fw-semibold d-block"
                                                            style="color: #000000;"><?php echo e(Auth::user()->name); ?></span>
                                                        <small class="text-muted"
                                                            style="color: #000000;"><?php echo e(Auth::user()->email); ?></small>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                            ...
                            <?php else: ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('login')); ?>" style="color: #000000;">
                                        <i class="bx bx-log-in me-2" style="color: #dc3545;"></i> Iniciar Sesión
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('register')); ?>" style="color: #000000;">
                    ...
                    <footer class="content-footer footer bg-footer-theme"
                        ...
                        <div
                            ...
                            <div class="mb-2 mb-md-0" style="color: #000000;">
                                © <?php echo e(date('Y')); ?>, Proyecto Salesiano Costa Norte
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
...
</html><?php /**PATH C:\laragon\www\Practicas_Proyecto_Salesiano_III-TSDS\prueba\resources\views/layaout/app.blade.php ENDPATH**/ ?>