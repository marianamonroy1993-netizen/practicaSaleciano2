...
<?php $__env->startSection('title', 'Editar Seguimiento Educador'); ?>
            ...
            <div class="col-12">
                <div class="card" style="background-color: #ffffff; border: 1px solid #808080;">
                    ...
                    <div class="card-body" style="background-color: #ffffff;">
                        <form action="<?php echo e(route('admin.educador.update', $educador)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $destinatarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destinatario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($destinatario->id); ?>" <?php echo e(old('destinatario_id', $educador->destinatario_id) == $destinatario->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="tipo" name="tipo"
                                        ...
                                        <option value="academico" <?php echo e(old('tipo', $educador->tipo) === 'academico' ? 'selected' : ''); ?>>Académico</option>
                                        <option value="convivencial" <?php echo e(old('tipo', $educador->tipo) === 'convivencial' ? 'selected' : ''); ?>>Convivencial</option>
                                        <option value="disciplinario" <?php echo e(old('tipo', $educador->tipo) === 'disciplinario' ? 'selected' : ''); ?>>Disciplinario</option>
                                        <option value="otro" <?php echo e(old('tipo', $educador->tipo) === 'otro' ? 'selected' : ''); ?>>Otro</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('fecha_registro', $educador->fecha_registro->format('Y-m-d'))); ?>" required
                                        style="border: 1px solid #808080; color: #000000;">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        style="border: 1px solid #808080; color: #000000;">
                                        <option value="bajo" <?php echo e(old('nivel_riesgo', $educador->nivel_riesgo) === 'bajo' ? 'selected' : ''); ?>>Bajo</option>
                                        <option value="medio" <?php echo e(old('nivel_riesgo', $educador->nivel_riesgo) === 'medio' ? 'selected' : ''); ?>>Medio</option>
                                        <option value="alto" <?php echo e(old('nivel_riesgo', $educador->nivel_riesgo) === 'alto' ? 'selected' : ''); ?>>Alto</option>
                                    </select>
                                ...
                                <div class="col-md-8 mb-3">
                                    <div class="form-check mt-4">
                                        <input class="form-check-input" type="checkbox" id="riesgo_detectado"
                                            name="riesgo_detectado" value="1" <?php echo e(old('riesgo_detectado', $educador->riesgo_detectado) ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        style="border: 1px solid #808080; color: #000000;"><?php echo e(old('observacion', $educador->observacion)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        style="border: 1px solid #808080; color: #000000;"><?php echo e(old('acuerdos', $educador->acuerdos)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo e(route('admin.educador.index')); ?>" class="btn"
...
<?php echo $__env->make('layaout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Practicas_Proyecto_Salesiano_III-TSDS\prueba\resources\views/admin/educador/edit.blade.php ENDPATH**/ ?>